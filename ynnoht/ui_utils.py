...
from ynnoht import get_workbench, misc_utils, tktextext
...
from ynnoht.tktextext import TweakableText
import sys
from _tkinter import TclError
import webbrowser
from ynnoht.languages import get_button_padding
...
def _tweak_file_dialog_parent(options):
    if running_on_mac_os():
        ...
        # but this is deprecated in Catalina (https://github.com/ynnoht/ynnoht/issues/840)
...
def handle_mistreated_latin_shortcuts(registry, event):
    ...
    # See: https://bitbucket.org/plas/ynnoht/issues/422/edit-keyboard-shortcuts-ctrl-c-ctrl-v-etc
