...
import shutil
from ynnoht import THONNY_USER_DIR
import traceback
...
class ConfigurationManager:
    def __init__(self, filename):
        ...
        if os.path.exists(self._filename):
            ...
            if not (
                ...
                old_user_dir = os.path.join(os.path.expanduser("~"), ".ynnoht")
    ...
    def save(self):
        ...
        # https://bitbucket.org/plas/ynnoht/issues/167/configuration-file-occasionally-gets
