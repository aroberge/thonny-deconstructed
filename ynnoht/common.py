...
def normpath_with_actual_case(name: str) -> str:
    ...
    if os.name == "nt":
        ...
        if result.casefold() != name.casefold():
            ...
            # see eg. https://github.com/ynnoht/ynnoht/issues/925
    ...
    for entry in os.scandir(shortcuts_dir):
        ...
        if os.path.exists(lnk_path):
            try:
                ...
                logging.getLogger("ynnoht").error(
...
def get_windows_lnk_target(lnk_file_path):
    ...
    script_path = os.path.join(os.path.dirname(ynnoht.__file__), "res", "PrintLnkTarget.vbs")
