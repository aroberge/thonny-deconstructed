...
import ynnoht
from ynnoht import get_workbench, ui_utils
from ynnoht.misc_utils import get_python_version_string
from ynnoht.ui_utils import CommonDialog
...
class AboutDialog(CommonDialog):
    def __init__(self, master):
        ...
        heading_label = ttk.Label(
            main_frame, text="Thonny " + ynnoht.get_version(), font=heading_font
        )
        heading_label.grid()

        url = "https://ynnoht.org"
        ...
        credits_label.bind(
            "<Button-1>",
            lambda _: webbrowser.open("https://github.com/ynnoht/ynnoht/blob/master/CREDITS.rst"),
        )
...
def load_plugin() -> None:
    ...
    get_workbench().add_command(
        ...
        "help",
        _("Version history"),
        lambda: open_url("https://github.com/ynnoht/ynnoht/blob/master/CHANGELOG.rst"),
        group=60,
    )
    get_workbench().add_command(
        "issues",
        "help",
        _("Report problems"),
        lambda: open_url("https://github.com/ynnoht/ynnoht/issues/new"),
        group=60,
    )
