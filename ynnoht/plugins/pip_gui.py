...
import ynnoht
from ynnoht import get_runner, get_workbench, running, tktextext, ui_utils
from ynnoht.common import InlineCommand, normpath_with_actual_case, is_same_path, path_startswith
...
from ynnoht.running import get_interpreter_for_subprocess
...
class BackendPipDialog(PipDialog):
    ...
    def _confirm_install(self, package_data):
        ...
        if name.lower().startswith("ynnoht"):
...
class PluginsPipDialog(PipDialog):
    ...
    def _conflicts_with_ynnoht_version(self, req_strings):
        import pkg_resources
        ...
        try:
            ...
            for req_string in req_strings:
                ...
                if req.project_name == "ynnoht" and ynnoht.get_version() not in req:
    ...
    def _confirm_install(self, package_data):
        ...
        if name.lower().startswith("ynnoht-") and not reqs:
            showerror(
            ...
            conflicts = self._conflicts_with_ynnoht_version(reqs)
            if conflicts:
                showerror(
