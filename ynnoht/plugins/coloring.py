...
from ynnoht.codeview import CodeViewText
from ynnoht.shell import ShellText
...
class SyntaxColorer:
    ...
    def _compile_regexes(self):
        from ynnoht.token_utils import (
            BUILTIN,
            COMMENT,
...
class CodeViewSyntaxColorer(SyntaxColorer):
    def _update_coloring(self):
        ...
        # Get rid of wrong open string tags (https://github.com/ynnoht/ynnoht/issues/943)
        search_start = viewport_start
        while True:
